...
//map function to create an array
//separate function into its own name and pass it into the map function as a value
//list prints out twice in the browser


function Greetings (name){
  var firstChar = name.charAt(0).toLowerCase();
 if (firstChar ==='j'){
    return  byeSpeaker.speak(name);
  }else{
    return helloSpeaker.speak(name);
  }
